...
\begin{claim}[\cite{GanzfriedSandholm13improving}, Proposition~1; \cite{BurchJohansonBowling13}]
...
Finally in Chapter~\ref{ch:max-margin}, we use these insights to~motivate our own, new technique: \emph{subgame-margin maximization}.
