...
To see difficulties with combining a~re-solved subgame strategy with an~original trunk strategy, we will consider the game of~\emph{rock-paper-scissors}\footnotemark{} as our running example.
