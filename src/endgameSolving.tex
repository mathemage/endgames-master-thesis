...
Nevertheless, that is still not enough for the large poker variants mentioned above.

Today, a~prevailing approach to solve huge imperfect-information games (such as \acrshort{lhe} or \acrshort{nlhe}) is to reduce their sizes by~means of~\emph{abstraction}:
\begin{description}
