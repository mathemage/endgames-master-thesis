...
\begin{figure}[H]
  ...
  \captionWithCite{A~gadget game for endgame solving\\}{Moravcik2016refining}
...
This can be seen from the extensive form of~rock-paper-scissors and Claim~\ref{claim:rps-subgame}.
