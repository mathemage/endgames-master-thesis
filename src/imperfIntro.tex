...
Not any two mappings $x\colon S_1 \to \R$ and $y\colon S_2 \to \R$ can be realization plans, though.
We need to add two types of~\acrshort{lp} constraints.
...
\begin{align}
  ...
  \begin{split}
    x(s_1(I)) &= \sum _{a \in A(I)} x(s_1(I \cdot a)), \quad I\in\I_1, \\
    y(s_2(I')) &= \sum _{a' \in A(I')} y(s_2(I' \cdot a')), \quad I'\in\I_2.
  \end{split}
\end{align}
