...
\begin{equation}
  ...
  \end{split}
\end{equation}
which is the standard \emph{sequence-form \acrshort{lp} formulation} used for solving extensive forms.
...
So zero-sum extensive-form games can be solved using (dual) linear programming on~the \emph{linear-sized} \acrshort{lp}~(\ref{lp:seq-form}).
