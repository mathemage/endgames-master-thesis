...
\begin{itemize}
  ...
  \item A~\emph{Nash equilibrium} (in the context of \acrshort{efg}s) is a~strategy profile $\sigma$ such that no player~$i \in P$ has any incentive to deviate from his strategy.
