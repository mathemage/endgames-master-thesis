...
\begin{thm}[\cite{BurchJohansonBowling13}]
  ...
  If $v_2^{\langle\sigma_1', \textrm{CBR}(\sigma_1')\rangle}(I) \leq  v_2^{\langle\sigma_1, \textrm{CBR}(\sigma_1)\rangle}(I)$ for all information sets $I$ at the root of subgame $S$, then $u_2^{\langle\sigma_1', \textrm{CBR}(\sigma_1')\rangle} \leq  u_2^{\langle\sigma_1, \textrm{CBR}(\sigma_1)\rangle}$.
\end{thm}
