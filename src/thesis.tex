...
\def\Dedication{%
  ...
  \begin{itemize}[$\to$]
    \item Milan, for taking the (uneasy) role of~my supervisor, for helping my EPFL dream come true, and for showing me the life of~``optimized consumption'',
    ...
    \item \href{http://www.azquotes.com}{azquotes.com}, for inspiring and amusing quotes, which I used to lighten up the technical dimness of~this work,
    \item my little brother, for his patience as my roommate during my work on this thesis,
    \item and last but not least, to my loving parents, for running our childhood smoothly, providing for us, and especially, for waking us up every single morning during our school years in~spite of~our deepest resistance.
  \end{itemize}
}
