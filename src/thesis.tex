...
\usepackage[backend=bibtex, style=reading, citestyle=authoryear-comp, entrykey=false]{biblatex} % citation style AUTHOR YEAR
...
\usepackage[justification=centering]{caption} % for centered captions
...
\part{Imperfections of~Imperfect-Information Games}
\include{chap02}
\include{chap03}
\include{chap04}
\include{chap05}
