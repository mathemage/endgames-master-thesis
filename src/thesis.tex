...
\def\Abstract{%
  ...
  Specialised endgame handling is rewarding for games with perfect information (e.g., Chess databases pre-computed for entire classes of~endings, or dividing Go board into seperate independent subgames).
  ...
  Unfortunately, such a~generalization cannot be solved straigthaway, as it does not generally preserve optimality.
