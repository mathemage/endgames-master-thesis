...
Abstrakt:
Koncovky hrají výraznou roli pro hráče.
...
V důsledku toho můžeme skončit se strategií mnohem ovlivnitelnější (co se týče zneužitelnosti).
...
\begin{enumerate}[(a)]
  ...
  \item nebo zformalizovat pojem \emph{rozmezí podhry} jakožtu míra zlepšení strategie.
    Pro ní zkonstruujeme pomocnou hru, jež co nejvíce zvětšuje rozmezí podhry.
\end{enumerate}
...
Též jsme porovnali skrze pokusy tři zmíněná řešení, s~použitím špičkového účastníka soutěže pokerových programů na AAAI-14.
