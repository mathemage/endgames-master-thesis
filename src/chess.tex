...
\begin{itemize}
  ...
  \item 
    ...
    \end{enumerate}
    \footnotetext{
      a~pawn with no opposing pawns to prevent it from advancing to the 8\textsuperscript{th} rank (i.e., there are no opposing pawns in~front of~it either on~the same file or on an~adjacent file)
    }
