  ...
  \item 
    ...
    \begin{enumerate}[(a)]
      ...
      \item \emph{Zugzwang}\footnotemark{} is often a factor in endgames and rarely in other stages of the game.
        \footnotetext{a~situation in~Chess wherein one player is put at a~disadvantage because he must make a~move even though he would prefer to pass and not move}
    \end{enumerate}
