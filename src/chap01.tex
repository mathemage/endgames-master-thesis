...
\begin{itemize}
  ...
  \item \textbf{The Longest Checkmates}
    The researches behind the Lomonosov tablebases discovered following endgames, proved to be the longest 7-man checkmates.
    \begin{description}
      \item [pawnless:]
        ...
        (\cite{Lomonosov2014eightlongest}) comments on the endgame as follows:
        \begin{quotation}
          \noindent
      ...
      \item [with pawns:]
        An~ending position of~\rookB Rook, \bishopB Bishop and \knightB Knight versus \queen Queen and \pawn Pawn (see Figure~\ref{fig:longest-7-man-checkmate}) is the absolute winner of~the longest 7-man checkmates:
        \begin{quotation}
          \noindent
