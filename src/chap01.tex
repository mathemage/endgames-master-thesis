...
An~\emph{endgame tablebase} is a~database of~pre-calculated, exhaustively analysed chess endgames stored as tables of~positions together with optimal consequent moves.
...
Tablebases are designed for given set of~pieces, e.g. king and queen versus king (KQK).
...
\begin{enumerate}[(1)]
  \item \textbf{Generation}:
    ...
    In~the case of~KQK, this amounts to $\approx 40000$ positions.
