...
The two obstacles of~heuristic board partition (in the sum game model) are (a) the impossibility of a~perfect, precise split and (b) the dependencies between the resulting subgames:
\begin{quotation}
...
Simple strategies for dealing with dependencies are pretending the games are independent, or re-searching a~bigger merged game.~(\cite{Muller1995computer})
\end{quotation}
