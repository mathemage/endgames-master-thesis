  ...
  \item \textbf{The longest checkmates}
    ...
    \begin{description}
      \item [pawnless:]
        ...
        The authors (\cite{Lomonosov2014eightlongest}) attributes this immense complexity to the balance of~piece values:
      ...
      \item [with pawns:]
        One simple idea to create an~even more complex endgame is to build on the previous position and make use of~pawns' promotion.
...
Since the focus of~our survey are imperfect-information games rather than Go, the current section heavily derives from that work.
