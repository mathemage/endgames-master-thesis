...
\begin{enumerate}[1]
  \item \textbf{Generation}:
    ...
    \begin{figure}[H]
      ...
      \showboard
      \captionWithCite{Non-symmetric positions for \BlackKingOnWhite}{Levy2009computers}
      \label{fig:non-symmetric-black-king}
    \end{figure}
    \begin{quotation}
      The \BlackKingOnWhite can be placed on~any of 10~squares a1, b1, c1, d1, b2, c2, d2, c3, d3, and d4 (see diagram on Figure~\ref{fig:non-symmetric-black-king}).
...
\begin{itemize}
  ...
  \item \textbf{Longest forced win}
    ...
    \begin{description}
      \item [among pawnless endgames]
        Rook, Bishop and Knight against Queen and Knight.
        Mate in 545.
