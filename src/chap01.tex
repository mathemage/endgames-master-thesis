...
In~his dissertation (\cite{Muller1995computer}), Martin Müller mentions the following advantages of~Go endgames for research:
\begin{itemize}
  ...
  \item The exact solution of~parts of~a~Go board facilitates the analysis of the rest.
    ...
    Human experts use similar reasoning: they observe the score continually from the early midgame, and base their strategic decisions on~such an~analysis [Takagawa 85].
