...
\end{enumerate}
M{\"u}ller proposes heuristic algorithms for playing the entire game, and exact algorithms for late endgame positions.
Thus, solving endgames in 1995---at the infancy of Computer Go---already played a~vital role.
