...
\begin{itemize}[-]
  ...
  \item In this model there is no concept of~long-range full board plans.
    This is probably not a~big issue until programs reach amateur Dan or even professional level \textit{(for an~update on current situation, see Subsection~\ref{ssec:AlphaGo})}.
\end{itemize}
