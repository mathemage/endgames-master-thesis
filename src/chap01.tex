...
\begin{itemize}
  ...
  \item \textbf{The Longest Checkmates}
    ...
    \begin{description}
      \item [pawnless:]
        ...
        \begin{figure}[H]
          ...
          \showboard
          \captionWithCite{KRBN-KQN: mate in 545 moves!}{Lomonosov2014eightlongest}
    ...
    Astonishingly, the authors note on the surprising ``gap'' in~number of~moves between these ``hateful eight`` and the next (9\textsuperscript{th}) longest 7-piece endgame:
