...
\end{itemize}
Hence, the work employs a~method of~applying an~elaborate mathematical theory (of~combinatorial game theory) to deal with the endgame phase.
...
It is also interesting to compare the technique of~(\cite{Muller1995computer}) with the modern approach of~\emph{AlphaGo}:
...
See Subsection~\ref{ssec:AlphaGo} for more details.

Another contributions of~(\cite{Muller1995computer}) are the ones aiding computer Go endgames specifically:
\begin{itemize}
